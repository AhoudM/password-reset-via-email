        ...
        <div class="row">
            ...
            <div class="box col-md-5">
                ...
                <div class="logo">
                    ...
                    <h4>Enter your registered email please</h4>
                </div>
                <div class="container">
                    <!-- form container -->
                    <form action="/fairy_booth/sending_reset_email.php" method="post">
                        <div class="row">
                        ...
                        <div class="row">
                            <?php
                                if(isset($_SESSION["mail_messages"])){
                                    echo($_SESSION["mail_messages"]);
                                    unset($_SESSION["mail_messages"]);
                                }
                            ?>
                        </div>
                        <div class="row">
                            <input class="btn btn-primary" name="reset" type="submit" value="Reset Password">
                        </div>
                        <div>
                            <p><a href="/fairy_booth/index.php" class="link">Go to login page</a></p>
                        </div>
                    </form>
                </div>
            </div>
